...
def generate_captions(menu_name: str, price: float) -> Dict[str, str]:
    ...
    prompt = f"""
        สร้างแคปชั่น Instagram 3 แบบสำหรับร้านข้าวขาหมู (ชื่อร้าน: ขาหมูน้าา)
        ชื่อเมนู: {menu_name}
        ราคา: {price} บาท
        
        โปรดสร้างแคปชั่น 3 แบบในรูปแบบต่อไปนี้:
        1. Cute: เป็นกันเอง สนุกสนาน มีอีโมจิ น้ำเสียงสบาย ๆ ชวนหิว
        2. Minimal: ง่าย สวยหรู ดูสะอาดสะอ้าน ใช้คำไม่มากนัก
        3. Gen-Z: ทันสมัย ตลกขบขัน เข้าใจง่าย ใช้สแลงสมัยใหม่ (เช่น ของแทร่, ตัวมารดา)
